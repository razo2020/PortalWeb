...
CREATE TABLE `detalle_guia` (
  `Guia_idGuia` varchar(11) NOT NULL,
  `idPosicion` int(11) NOT NULL,
  `cantidad` float NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`Guia_idGuia`,`idPosicion`),
  CONSTRAINT `fk_Detalle_Guia_Guia1` FOREIGN KEY (`Guia_idGuia`) REFERENCES `guia` (`idGuia`) ON DELETE NO ACTION ON UPDATE NO ACTION
